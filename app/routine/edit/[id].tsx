...
export default function EditRoutineScreen() {
  ...
  const routineId = firstParam(params.id);
  ...
  const [goal, setGoal] = useState<RoutineGoal | undefined>(routine?.goal ?? 'Strength');
  ...
  const isDirty = useMemo(() => {
    ...
    return (
      ...
      goal !== routine.goal ||
      JSON.stringify(routineExercises) !== JSON.stringify(routine.exercises)
    );
  }, [description, goal, name, routine, routineExercises]);
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        <View style={styles.missingWrap}>
          ...
          <Text style={styles.emptyText}>
            This routine may have been deleted or is no longer available.
          </Text>
          <PrimaryButton
            label="Back to Train"
            variant="outline"
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
      ...
      >
        <View style={styles.topBar}>
          ...
          <Text style={styles.topBarTitle}>Edit Routine</Text>
        ...
        >
          ...
          {routineExercises.length === 0 ? (
            <AppCard style={{ marginBottom: spacing.lg }}>
              <Text style={styles.emptyText}>No exercises yet. Add from the library below.</Text>
            </AppCard>
          ) : (
